...
<!DOCTYPE html>
	<html lang="es">
		...
		<body>
							...
							<div class = "titlePanel col-12">
								...
								<div class = "halfHolder col-12">
									<form>
										...
										<br>
										<input type="password" id="passUser" placeholder="Clave" required>
										<br>
										...
										<br>
										<input type="submit" id ="saveUser" value = "Agregar Usuario"/>
									</form>
								</div>								
							</div>
			...
			<!-- -------- Modal windows --------- -->
				<!-- ******EditUser***** -->
			<div class = "modalPanel" id = "editUser">
				<div class ="modalInnerPanel" id = "formEditUser">
					<h1>Usuario id
						<p id = "idUserLbl">
