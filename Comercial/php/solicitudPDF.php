<?php
    ...
    $body = '<div class = "col-12 rowcnt" style="margin-top:15px;font-size:12px"> 
            ...
            <div class ="col-12" style = "text-align:center;padding-top:150px">
                        <div class="col-5" style = "padding:2px;border-top:2px solid black;">EJECUTIVO 1 <br> CORSI</div>
                        <div class="col-2">&nbsp;</div>
                        <div class="col-5" style = "padding:2px;border-top:2px solid black;">EJECUTIVO 1 <br> CLIENTE</div>
                        <div class="col-4">&nbsp;</div> 
                        <div class="col-5" style = "padding:2px;margin-top:100px;border-top:2px solid black;">EJECUTIVO 1 <br> TRASNPORTISTA</div>
